...
{ 
    ...
    public function index()
    {
        ...
        $menuname = 'রিপোর্টস';
        return view('check_register.check_register',compact('years','menuname','upangshos','incoexpense'));
    }
    ...
    public function updateexpense($x){
        ...
        Incoexpense::where('vat_tax_status', $x) ->update(['status' => 1]);
    ...
    public function store(Request $request){
		...
		$ed = $request->ed;
        $menuname = 'রিপোর্টস';
        $checkregister = Incoexpense::checkregister($upangso, $year, $sd, $ed);
        
        return view('check_register.check_register', compact('sd', 'ed', 'upangso', 'checkregister', 'year', 'years', 'menuname', 'upangshos', 'incoexpense'));
    }
