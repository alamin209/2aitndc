...
@section('content')
                ...
                <div class="panel-body">
                    <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{url('/')}}/incoexpense">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="textarea" class="form-control" placeholder="খাতের বিবরণ" id="khat_des" name="khat_des" minlength="2">
                            </div>
                        </div> 
						...
						<div class="form-group">
							<label for="inputSuccess" class="col-sm-2 control-label col-lg-2"><strong>উপাংশ</strong></label>
							<div class="col-lg-10">
								<select class="form-control m-bot15" id="" name="" onchange="getbankdetailsaccourdingtoupangshoid(this.value)">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="text" class="form-control" placeholder="চেক নম্বর" id="check_no" name="check_no" minlength="2">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputSuccess" class="col-sm-2 control-label col-lg-2">
                         ...
                         <div class="form-group">
                             <label for="inputSuccess" class="col-sm-1 control-label col-lg-1">
                                 <strong>ভ্যাট</strong></label>
                             <div class="col-lg-3">
                                 <input type="number" step="any"  class="form-control" placeholder="ভ্যাট" id="vat" name="vat"  >
                             </div>
                             <label for="inputSuccess" class="col-sm-1 control-label col-lg-1" style="text-align: right">
                                 <strong>ভাউচার নম্বর/চালান</strong></label>
                             <div class="col-lg-3">
                                 <input type="text"   class="form-control" placeholder="ভ্যাট" id="vatvourcher_no" name="vatvourcher_no"  >
                             </div>
                             <label for="inputSuccess" class="col-sm-1 control-label col-lg-1" style="text-align: right">
                                 <strong>চেক নম্বর</strong></label>
                             <div class="col-lg-3">
                                 <input type="text"  class="form-control" placeholder="ভ্যাট" id="vat" name="vat_check_no"  >
                             </div>
                         </div>
                        ...
                        <div class="form-group">
                            ...
                            <label for="inputSuccess" class="col-sm-1 control-label col-lg-1">
                                <strong>আয় কর</strong></label>
                            <div class="col-lg-3">
                                <input type="number"  class="form-control" placeholder="আয় কর" id="vat" name="tax"  >
                            </div>
                            <label for="inputSuccess" class="col-sm-1 control-label col-lg-1" style="text-align: right">
                                <strong>ভাউচার নম্বর/চালান</strong></label>
                            <div class="col-lg-3">
                                <input type="text"   class="form-control" placeholder="আয় কর" id="tax" name="taxvourcher_no"  >
                            </div>
                            <label for="inputSuccess" class="col-sm-1 control-label col-lg-1" style="text-align: right">
                                <strong>চেক নম্বর</strong></label>
                            <div class="col-lg-3">
                                <input type="text"   class="form-control" placeholder="আয় কর" id="vat" name="tax_check_no"  >
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <input type="date" class="form-control" placeholder="প্রারম্ভিক স্থিতি" id="receive_date" name="receive_date" minlength="2">
                            </div>
                        </div>
  ...
  <style>
    ...
    .khattypes, .khats, .inout, .accounts{ display:none; }  
  </style>
...
<script>
	...
	function getbankdetailsaccourdingtoupangshoid(id){
