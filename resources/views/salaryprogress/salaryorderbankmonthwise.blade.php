            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body addfrom">
                        <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{ url('/')}}/SalaryOrderbank">
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <button type="submit" name="action"   value="SaveSalery"  class="btn btn-primary pull-right col-lg-offset-1">Process</button>
                                </div>
                            </div>
                        </form>
