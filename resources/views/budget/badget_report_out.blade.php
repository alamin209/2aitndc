        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
					<h3 style="">ব্যয় বাজেট রিপোর্ট</h3>
                </header>
                 @if (session('message'))
                ...
                <div class="panel-body">
					<form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{url('/')}}/budget_report/out">
                        {{csrf_field()}}
					...
					<div class="adv-table">@isset($year)
						...
						<div id="printarea">
    						<div class="col-lg-12" style="text-align:center; margin-bottom:20px">
    							...
    							<span>@isset($upangshoname)
    								{{ $upangshoname }}
    							@endisset</span>
    							<h3 style="text-align: center;">ব্যয়</h3>
    						</div>
