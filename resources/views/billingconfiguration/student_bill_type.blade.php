            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body addfrom">
                        <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{url('/')}}/student_bill_type">
                            {{csrf_field()}}
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong> Student Bill Type *</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Student Bill Type Name " id="bill_type_name" name="bill_type_name" required >
                                </div>
                            </div>
