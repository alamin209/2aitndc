            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body addfrom">
                        <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{url('/')}}/product_distribution" enctype="multipart/form-data" >
                            {{csrf_field()}}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <select class="form-control m-bot15"  id="products" name="product_id" o required>
...
{{--                            </div>--}}
                            ...
                            <div class="form-group" >
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong>Assign To Employee </strong></label>
                                <div class="col-lg-10">
                                    <select class="form-control m-bot15"  name="empl_id" id="empl_id" required>
                                        <option value="">Select Employee </option>
                                        @foreach($employ as $em)
                                            <option value="{{ $em->id }}">{{ $em->add_full_name }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="form-group" >
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong>Remark* </strong></label>
                                <div class="col-lg-10">
                                    <textarea  class="form-control" placeholder="Write Note " id="note" name="renmark" required > </textarea>
                                </div>
                            </div>
                            <div class="form-group" >
                            ...
                            <div class="form-group" >
                                ...
                                <div class="col-lg-10">
                                    <input type="date" class="form-control" placeholder="Write date" id="qty" name="date_ofdistribution" required >
