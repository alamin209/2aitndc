            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body addfrom">
                        <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{url('/')}}/createinventory">
                            {{csrf_field()}}

                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong> Category Name*</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Inventory Category Name " id="catgeory_name" name="catgeory_name" required >
                                </div>
                            </div>
							<div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong>Depreciation (%)</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Enter Depreciation %" id="" name="depricit">
                                </div>
                            </div>
{{--                            <div class="form-group">--}}
{{--                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong> Status* </strong></label>--}}
{{--                                <div class="col-lg-10">--}}
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <table class="display table table-bordered" id="myTable">
                                ...
                                @foreach($inventorycat as $dep)
                                    @if($dep->id!=0)

                                        <tr class="gradeX">
                                            <td>{{ $dep->catgeory_name }}</td>
                                            <td align="right"> {{ $dep->depricit }}
                                             %</td>
                                            <td>
