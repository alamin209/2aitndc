            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body addfrom">
                        <form role="form" class="cmxform form-horizontal tasi-form" id="MenuForm"  method="post"  id="commentForm" action="{{url('/')}}/add_supplier">
                            {{csrf_field()}}

                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong> Supplier Name*</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Supplier name " id="name" name="name" required >
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong> Company name*</strong></label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" placeholder="Supplier Company name " id="companey_name" name="companey_name" required >
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputSuccess" class="col-sm-2 control-label col-lg-2 lab"><strong> Company Address*</strong></label>
                                <div class="col-lg-10">
{{--                                    <input type="text" class="form-control" placeholder="Supplier Company name " id="companey_name" name="companey_name" required >--}}
                                    <textarea name="address"  class="form-control"  placeholder="Supplier Company Address "  required></textarea>
                                </div>
                            </div>
