            ...
            <section class="panel">
                ...
                <div id="printarea" class="panel-body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td colspan="2" style="padding: 2px 2px 2px 2px;border: none;text-align: center;font-size: 20px;font-weight: bold">{{ $product->subject_names}}</td>
                        </tr>
{{--                        <tr>--}}
{{--                            <td colspan="2" style="padding: 2px 2px 2px 2px;border: none;text-align: center;">Session {{ $product->sessions }}</td>--}}
{{--                        </tr>--}}
                        <tr>
                            <td style="border: none;" >Product Name : <b>{{ $product->product_name}}</b></td>
                            <td style="border: none;" >
                                ...
                                <p id="notdisplau">
                                Document:
                                <?php  $path='public/admin/inventorydocument/'.$product->doc_name ?>
                                @if ($product->doc_name  != '')
                                    @if (file_exists($path))
                                        <a href="{{url('/')}}/public/admin/inventorydocument/{{ $product->doc_name }}" target="_blank" class="btn btn-primary m-btn--pill m-btn--air btn-sm"><i class="flaticon-eye">Click To Show</i></a>
                                    @else
                                        {{ 'No File Upload' }}
                                    @endif
                                @else
...
{{--                            <td style="border: none;" colspan="2">Purpose : Admission form and prospectus for {{ $slip->subject_names}}</td>--}}
                        ...
                        <tr>
                            <td style="border: none;" colspan="2">Amount (in words) <b id="word" style="margin-left: 10px;margin-right: 10px;font-size: 15px;"></b>TK. <input id="amounts" style=" text-align: center; margin-left: 10px;" readonly="" type="text" value="{{ $product->purchase_cost}}"/></td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 2px 2px 2px 2px;border: none;">Admin's signature</td>
                            <td style="padding: 2px 2px 2px 2px;border: none;text-align: right">Account's signature</td>
                        </tr>
