                ...
                <div class="panel-body" style="background:#008B8B;color:white; ">
                    <form class="cmxform form-horizontal tasi-form" id="addUserForm"  role="form" method="post"  
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control" name="expenseType" id="expense_type"  required onchange="gettypes(this.value)"> <!-- input-sm m-bot15  -->
                                    <option value="">Select Type</option>
                                    @foreach($incomecats as $type)
						...
						<div class="form-group">
                            ...
                            <div class="col-lg-10">
                                <select class="form-control" name="exptype" id="exptype"  required> <!-- input-sm m-bot15  -->
                                    <option value="">Select Type</option>
